...
<body class="overflow-x-hidden align-items-center mx-auto">
    ...
    <div class="row w-100 h-75 border-bottom mx-0 mt-5 mt-lg-0">
        <div class="col-12 col-lg-5 mx-auto border-end-lg border-bottom border-bottom-lg-0 mt-lg-10 p-4 p-lg-0">
            <div class="d-lg-none mx-auto justify-content-center text-center px-2 py-3">
                <h1 class="fs-2 fw-light text-muted">Where professionals meet and grow together</h1>
                <div class="d-flex flex-column gap-3 align-items-center mt-4 mx-auto" style="max-width: 320px;">
                    <x-button-main provider="google" class="fs-10 w-100"/>
                    <x-button-main provider="microsoft" class="fs-10 w-100"/>
                    <x-button-main provider="apple" class="fs-10 w-100"/>
                    <div class="d-flex align-items-center my-2 w-100">
                        <hr class="flex-grow-1">
                        <span class="mx-3 text-muted">or</span>
                        <hr class="flex-grow-1">
                    </div>
                    <a href="{{'/login'}}" class="w-100"><x-button-main provider="connexa" class="fs-10 w-100"/></a>
                    <p class="text-center text-muted fs-15 w-100 mt-2 mx-auto">By clicking Continue to join or sign in, you agree to Connexa's User Agreement, Privacy Policy, and Cookie Policy.</p>
                </div>
                <p class="mt-4 text-center">
                    New to Connexa?
                    <a href="{{ route('register.form') }}" class="register-link fw-bold text-primary ms-1">Join Now</a>
                </p>
            </div>
        ...
        <div class="col-12 col-lg-7 d-none d-lg-block hero-section"></div>
    </div>
    <div class="container second-section w-100 pt-5 pt-lg-10 px-3 px-md-0">
        ...
        <div class="container row mx-auto d-lg-none border py-5 rounded g-4">
            <div class="col-12 mx-auto text-center">
                ...
                <img src="{{asset('IMG/asset/preview3.png')}}" alt="" class="mt-3 img-fluid" style="max-width: 350px;">
            </div>
            <div class="col-12 mx-auto text-center mt-5">
                ...
                <img src="{{asset('IMG/asset/preview4.png')}}" alt="" class="mt-3 img-fluid" style="max-width: 350px;">
            </div>
            <div class="col-12 mx-auto text-center mt-5">
                ...
                <img src="{{asset('IMG/asset/preview1.png')}}" alt="" class="mt-3 img-fluid" style="max-width: 350px;">
            </div>
            <div class="col-12 mx-auto text-center mt-5">
                ...
                <img src="{{asset('IMG/asset/preview5.png')}}" alt="" class="mt-3 img-fluid" style="max-width: 350px;">
            </div>
        </div>
    </div>
    <div class="section w-100 mt-5 mt-lg-10 bg-brokenWhite mx-auto shadow-sm py-4 py-lg-5">
        <div class="container row mx-auto justify-content-center align-items-center g-4">
            <div class="col-12 col-md-6 text-center text-md-start">
                <h2 class="w-100 fs-3 fs-md-4 fw-light">Learn from the best. Grow with those who’ve been there</h2>
                <p class="w-100 fw-light text-muted">Connexa bridges experience and ambition, helping professionals learn from global pioneers and grow alongside the world’s most influential minds</p>
            </div>
            <div class="col-12 col-md-6 text-center">
                <img src="{{asset('IMG/asset/specialist.png')}}" alt="" class="prev-img-3 img-fluid">
            </div>
        </div>
    </div>
    <div class="section w-100 mt-5 mx-auto text-center py-4">
        <div class="container row mx-auto text-center align-items-center g-4">
            <div class="col-12 col-md-6 text-center text-md-start">
                <h2 class="w-100 fs-3 fs-md-4 fw-light">Find the Right Talent for Your Company</h2>
                <p class="w-100 fw-light mb-4">Post job openings easily and reach thousands of professionals ready to join your team</p>
                <a class="btn btn-outline-primary p-2 px-4 fw-bold rounded-pill" href="#">Post a job</a>
            </div>
            <div class="col-12 col-md-6 text-center">
                <img src="{{asset('IMG/asset/preview6.png')}}" alt="" class="prev-img-2 img-fluid">
            </div>
        </div>
    </div>
    <div class="section w-100 mt-5 mt-lg-10 bg-primary mx-auto py-3 overflow-hidden">
        ...
        <div class="container px-3 d-lg-none d-block text-center py-4">
            <div class="mb-4">
                <img src="{{asset('IMG/asset/footer.png')}}" alt="Connexa Logo" class="img-fluid" style="max-width: 180px;">
            </div>
            <div class="row g-3 text-start text-white justify-content-center my-3">
                <div class="col-6 col-sm-4">
                    <h6 class="text-white fw-bold mb-2 pb-1 border-bottom border-light border-opacity-25">General</h6>
                    <a class="fs-7 nav-link-2 d-block py-1" href="#">Sign In</a>
                    <a class="fs-7 nav-link-2 d-block py-1" href="#">Join</a>
                    <a class="fs-7 nav-link-2 d-block py-1" href="#">GitHub</a>
                    <a class="fs-7 nav-link-2 d-block py-1" href="#">About</a>
                    <a class="fs-7 nav-link-2 d-block py-1" href="#">Developer</a>
                </div>
                <div class="col-6 col-sm-4">
                    <h6 class="text-white fw-bold mb-2 pb-1 border-bottom border-light border-opacity-25">Browse Connexa</h6>
                    <a class="fs-7 nav-link-2 d-block py-1" href="#">Jobs</a>
                    <a class="fs-7 nav-link-2 d-block py-1" href="#">Learning</a>
                    <a class="fs-7 nav-link-2 d-block py-1" href="#">People</a>
                    <a class="fs-7 nav-link-2 d-block py-1" href="#">Companies</a>
                    <a class="fs-7 nav-link-2 d-block py-1" href="#">Top Content</a>
                </div>
                <div class="col-12 col-sm-4 mt-3 mt-sm-0">
                    <h6 class="text-white fw-bold mb-2 pb-1 border-bottom border-light border-opacity-25">Business Solution</h6>
                    <a class="fs-7 nav-link-2 d-block py-1" href="#">Promotion Ads</a>
                    <a class="fs-7 nav-link-2 d-block py-1" href="#">Recruit Talent</a>
                    <a class="fs-7 nav-link-2 d-block py-1" href="#">Marketing</a>
                    <a class="fs-7 nav-link-2 d-block py-1" href="#">Companies</a>
                    <a class="fs-7 nav-link-2 d-block py-1" href="#">Top Content</a>
                </div>
            </div>
            <div class="mt-4 pt-2 pb-2">
                <img src="{{asset('IMG/asset/download2.png')}}" alt="Download App" class="img-fluid" style="max-width: 260px;">
            </div>
        </div>
    </div>
